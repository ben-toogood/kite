...
var file_users_users_proto_rawDesc = []byte{
	...
	0x73, 0x65, 0x72, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x32, 0x73,
	...
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x2c, 0x0a, 0x03, 0x47, 0x65, 0x74, 0x12, 0x11, 0x2e, 0x75,
	0x73, 0x65, 0x72, 0x73, 0x2e, 0x47, 0x65, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a,
	0x12, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x73, 0x2e, 0x47, 0x65, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f,
	...
	0x74, 0x65, 0x2f, 0x75, 0x73, 0x65, 0x72, 0x73, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
var file_users_users_proto_goTypes = []interface{}{
	...
	nil,                         // 5: users.GetResponse.UsersEntry
	(*timestamp.Timestamp)(nil), // 6: google.protobuf.Timestamp
}
var file_users_users_proto_depIdxs = []int32{
	6, // 0: users.User.created_at:type_name -> google.protobuf.Timestamp
	6, // 1: users.User.updated_at:type_name -> google.protobuf.Timestamp
	0, // 2: users.CreateResponse.user:type_name -> users.User
	5, // 3: users.GetResponse.users:type_name -> users.GetResponse.UsersEntry
	0, // 4: users.GetResponse.UsersEntry.value:type_name -> users.User
	1, // 5: users.UsersService.Create:input_type -> users.CreateRequest
	3, // 6: users.UsersService.Get:input_type -> users.GetRequest
	2, // 7: users.UsersService.Create:output_type -> users.CreateResponse
	4, // 8: users.UsersService.Get:output_type -> users.GetResponse
