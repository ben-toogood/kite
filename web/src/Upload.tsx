  ...
  if (previewImage) {
    return (
      <div className="flex flex-col items-center w-1/3 p-4 mt-6 border-2">
        ...
        ></textarea>
        <button className="relative flex justify-center w-full px-4 py-2 mt-4 font-bold text-white bg-blue-400 border border-transparent text-l group rounded-mdfocus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
          Upload
        </button>
      </div>
    );
